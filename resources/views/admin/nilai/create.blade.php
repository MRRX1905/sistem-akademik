...
<div class="container">
    ...
    <form action="{{ route('nilai.store') }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="number" name="nilai_tugas" id="nilai_tugas" class="form-control" value="{{ old('nilai_tugas') }}" min="0" max="100" step="0.01">
            @error('nilai_tugas')<div class="text-danger">{{ $message }}</div>@enderror
        </div>
        <div class="mb-3">
            <label for="nilai_uts" class="form-label">Nilai UTS</label>
            <input type="number" name="nilai_uts" id="nilai_uts" class="form-control" value="{{ old('nilai_uts') }}" min="0" max="100" step="0.01">
            @error('nilai_uts')<div class="text-danger">{{ $message }}</div>@enderror
        </div>
        <div class="mb-3">
            <label for="nilai_uas" class="form-label">Nilai UAS</label>
            <input type="number" name="nilai_uas" id="nilai_uas" class="form-control" value="{{ old('nilai_uas') }}" min="0" max="100" step="0.01">
            @error('nilai_uas')<div class="text-danger">{{ $message }}</div>@enderror
        </div>
        <div class="mb-3">
            <label for="nilai_akhir" class="form-label">Nilai Akhir</label>
            <input type="number" name="nilai_akhir" id="nilai_akhir" class="form-control" value="{{ old('nilai_akhir') }}" min="0" max="100" step="0.01">
