...
<div class="container">
    ...
    <form action="{{ route('krs.update', $krs) }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <select name="mahasiswa_id" id="mahasiswa_id" class="form-control" required>
                ...
                @foreach($mahasiswas as $mahasiswa)
                    <option value="{{ $mahasiswa->id }}" {{ old('mahasiswa_id', $krs->mahasiswa_id) == $mahasiswa->id ? 'selected' : '' }}>
        ...
        <div class="mb-3">
            ...
            <select name="mata_kuliah_id" id="mata_kuliah_id" class="form-control" required>
                ...
                @foreach($mataKuliahs as $mataKuliah)
                    <option value="{{ $mataKuliah->id }}" {{ old('mata_kuliah_id', $krs->mata_kuliah_id) == $mataKuliah->id ? 'selected' : '' }}>
        ...
        <div class="mb-3">
            ...
            <select name="dosen_id" id="dosen_id" class="form-control" required>
                ...
                @foreach($dosens as $dosen)
                    <option value="{{ $dosen->id }}" {{ old('dosen_id', $krs->dosen_id) == $dosen->id ? 'selected' : '' }}>
        ...
        <div class="mb-3">
            ...
            <input type="text" name="tahun_akademik" id="tahun_akademik" class="form-control" value="{{ old('tahun_akademik', $krs->tahun_akademik) }}" placeholder="Contoh: 2024/2025" required>
        ...
        <div class="mb-3">
            ...
            <select name="semester" id="semester" class="form-control" required>
                ...
                <option value="Pendek" {{ old('semester', $krs->semester) == 'Pendek' ? 'selected' : '' }}>Pendek</option>
            </select>
        ...
        <div class="mb-3">
            ...
            <select name="status" id="status" class="form-control" required>
                ...
                <option value="nonaktif" {{ old('status', $krs->status) == 'nonaktif' ? 'selected' : '' }}>Nonaktif</option>
            </select>
