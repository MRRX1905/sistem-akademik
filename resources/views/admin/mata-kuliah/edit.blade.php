...
<div class="container">
    ...
    <form action="{{ route('mata-kuliah.update', $mataKuliah) }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="kode_mk" id="kode_mk" class="form-control" value="{{ old('kode_mk', $mataKuliah->kode_mk) }}" required>
            @error('kode_mk')<div class="text-danger">{{ $message }}</div>@enderror
        </div>
        <div class="mb-3">
            <label for="nama_mk" class="form-label">Nama Mata Kuliah</label>
            <input type="text" name="nama_mk" id="nama_mk" class="form-control" value="{{ old('nama_mk', $mataKuliah->nama_mk) }}" required>
        ...
        <div class="mb-3">
            ...
            <input type="text" name="semester" id="semester" class="form-control" value="{{ old('semester', $mataKuliah->semester) }}" required>
            @error('semester')<div class="text-danger">{{ $message }}</div>@enderror
        </div>
        <div class="mb-3">
            <label for="program_studi" class="form-label">Program Studi</label>
            <input type="text" name="program_studi" id="program_studi" class="form-control" value="{{ old('program_studi', $mataKuliah->program_studi) }}" required>
